    ...
    var spec:[materialsOB]=[]
        ...
        extension SecViewController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
            ...
            func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "branchCElll", for: indexPath) as? BranchCell
                
                let obj = spec[indexPath.row]
                
                cell?.lblTitle.text = obj.materialName
        ...
        //        }
            ...
            func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
                ...
                let vc = storyboard.instantiateViewController(withIdentifier: "subDetiealBranchVC") as! subDetiealBranchVC
                
                
                var  obj = spec[indexPath.row]
                
            
                vc.iDD = obj.id
                vc.title = obj.materialName
